...
/**
 * The Class SyntaxMarkdownHelper. Outputs something useable on GitHub.
 * 
 * @author sergio
 */
public class SyntaxerMarkdown implements ISyntaxer {
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.tensin.common.tools.documentation.updater.ISyntaxer#buildFileHeader(java.lang.String,
	 *      java.lang.String)
	 */
	@Override
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.tensin.common.tools.documentation.updater.ISyntaxer#buildHeader(int,
	 *      java.lang.String)
	 */
	@Override
	public String buildHeader(final int level, final String value) {
		...
		sb.append(" ").append(value).append(LINE_SEPARATOR)
 ...
 * content](http://github.github.com/github-flavored-markdown
 * /sample_content.html).*
 * 
 ...
 * 
 * In addition to the changes in the previous section, certain references are
 * auto-linked: - SHA: be6a8cc1c1ecfe9489fb51e4869af15a13fc2cd2 User@SHA ref:
 * mojombo@be6a8cc1c1ecfe9489fb51e4869af15a13fc2cd2 User/Project@SHA:
 * mojombo/god@be6a8cc1c1ecfe9489fb51e4869af15a13fc2cd2 \#Num: #1 User/#Num:
 * mojombo#1 User/Project#Num: mojombo/god#1
 * 
 * These are dangerous goodies though, and we need to make sure email addresses
 * don't get mangled:
 * 
 ...
 * 
 * In first grade I learned that 5 > 3 and 2 < 7. Maybe some arrows. 1 -> 2 ->
 * 3. 9 <- 8 <- 7.
 * 
 ...
 * 
 * Red Apples Purple Grapes Green Kiwifruits
 * 
 * Let's get crazy:
 * 
 ...
 * 
 * <dl> <dt>Lower cost</dt> <dd>The new version of this product costs
 * significantly less than the previous one!</dd> <dt>Easier to use</dt>
 * <dd>We've changed the product so that it's much easier to use!</dd> </dl>
 * 
 * I am a robot ------------
 * 
 * Maybe you want to print `robot` to the console 1000 times. Why not?
 * 
 * def robot_invasion puts("robot " * 1000) end
 * 
 * You see, that was formatted as code because it's been indented by four
 * spaces.
 * 
 ...
 * plan for it... I'm sure something will pop into my head here in > the midst
 * of this press conference, with all the pressure of trying to > come up with
 * answer, but it hadn't yet... >SyntaxerMarkdown > I don't want to sound like >
 * I have made no mistakes. I'm confident I have. I just haven't - you > just
 * put me under the spot here, and maybe I'm not as quick on my feet > as I
 * should be in coming up with one.
 * 
 * Table for two -------------
 * 
 * <table> <tr> <th>ID</th><th>Name</th><th>Rank</th> </tr> <tr>
 * <td>1</td><td>Tom Preston-Werner</td><td>Awesome</td> </tr> <tr>
 * <td>2</td><td>Albert Einstein</td><td>Nearly as awesome</td> </tr> </table>
 * 
 * Crazy linking action --------------------
 * 
 * I get 10 times more traffic from [Google] [1] than from [Yahoo] [2] or [MSN]
 * [3].
 * 
 * [1]: http://google.com/ "Google" [2]: http://search.yahoo.com/ "Yahoo Search"

...
public class UpdateBootConstants {
    ...
    public static void main(final String[] args) throws CoreException {
        ...
        inputs.add(AdapterBootConstants.buildAdapter("src/main/java/org/tensin/beerduino/boot/BootConstants.java", "LIBS"));

        final Collection<IAdapterOutput> outputs = new ArrayList<IAdapterOutput>();
        outputs.add(AdapterDump.buildAdapter());
        outputs.add(AdapterBootConstants.buildAdapter("src/main/java/org/tensin/beerduino/boot/BootConstants.java", "LIBS", true));

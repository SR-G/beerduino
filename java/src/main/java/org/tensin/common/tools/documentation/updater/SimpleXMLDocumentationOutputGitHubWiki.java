 ...
 */
public class SimpleXMLDocumentationOutputGitHubWiki implements ISimpleXMLDocumentationOutput {
    ...
    public String toMarkDown(final SimpleXMLDocumentationEntity currentEntity, final Set<String> alreadyDisplayed) {
        ...
        sb.append(SyntaxGitHubHelper.buildLink(currentEntity.getType().getAnchor())).append("\n\n");
